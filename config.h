...
static const int force_bar_height   = 36;
static const Bool viewontag         = True;     /* Switch view on tag switch */
static const int max_tag_name_width = 400;
static const int trianglewidth			= force_bar_height / 4;
static const char *fonts[] = {"Hack:style=Regular:size=14", "Fira Mono:style=Regular:size=14", "Symbols Nerd Font:size=16"};
#define QUOTED_(x) #x
#define QUOTED(x) QUOTED_(x)
#define dmenufont "Hack:style=Regular:size=14"
